...
public class BattleAudioManager : MonoBehaviour
{
    ...
    public enum Sfx { damage, lightSwordAtk, sfx_shieldsUp = 7, victory1, victory2, doubleBladeAtk, arrowAttack = 15, healing, heavyWeaponAttack, deadSound = 19, movingOnGrass, magicSpell, lose}
    ...
    private void SetupWeaponToSfxMap()
    {
        weaponToSfxMap = new Dictionary<Unit.WeaponType, Sfx>
        {
            ...
            {Unit.WeaponType.HeavyAttack, Sfx.heavyWeaponAttack},
            {Unit.WeaponType.MagicAttack, Sfx.magicSpell}
        };
    }
