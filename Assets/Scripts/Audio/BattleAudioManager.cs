...
public class BattleAudioManager : MonoBehaviour
{
    ...
    public enum Sfx { damage, lightSwordAtk, sfx_shieldsUp = 7, victory1, victory2, doubleBladeAtk, arrowAttack = 15, healing, heavyWeaponAttack, deadSound = 19, movingOnGrass}
