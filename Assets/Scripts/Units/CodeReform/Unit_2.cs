...
public abstract class Unit_2 : MonoBehaviour
{
    #region enum
    ...
    {
        if (moveLeft <= 0) return false; // Make sure one can't move while moving
    ...
    public abstract bool UtilAbility();
    public abstract bool MoveAbility();
